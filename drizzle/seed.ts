...
async function main() {
  ...
  const categoryMap = Object.fromEntries(
    ...
    import { db } from '../server/db'; // adjust this import based on your db file location
import { products, categories } from './schema';
import { eq } from 'drizzle-orm';
...
async function seed() {
  ...
  const categoryData = [
    ...
    { name: 'Riz & Staples', slug: 'riz-staples', image: '/images/categories/rice.jpg' },
    { name: 'Farines & Atta', slug: 'farines-atta', image: '/images/categories/flour.jpg' },
    { name: 'Snacks & Namkeen', slug: 'snacks-namkeen', image: '/images/categories/snacks.jpg' },
    { name: 'Pickles & Chutneys', slug: 'pickles-chutneys', image: '/images/categories/pickles.jpg' },
    { name: 'Frozen & Dairy', slug: 'frozen-dairy', image: '/images/categories/frozen.jpg' },
  ];
  ...
  // 3. Insert realistic products (20 items – expand as needed)
  const productData = [
    // Épices & Masalas
    {
      ...
      brand: 'Shan',
      description: 'Authentic blend for restaurant-style Bombay biryani',
    ...
    },
    {
      ...
      brand: 'National',
      description: 'Rich spice mix for tender chicken curry',
    ...
    },
    {
      ...
      brand: 'Shan',
      description: 'Creamy & mild – perfect for family dinners',
    ...
    },
    {
      ...
      brand: 'Laziza',
      description: 'Bold flavor for authentic karahi',
    ...
    // Riz & Staples
    {
      ...
      brand: 'Heer',
      description: 'Premium long-grain basmati – aged for aroma',
    ...
    },
    {
      ...
      brand: 'Daawat',
      description: 'Extra-long grain – restaurant quality',
    ...
    // Farines & Atta
    {
      ...
      brand: 'Aashirvaad',
      description: 'Chakki-fresh whole wheat for soft rotis',
    ...
    // Snacks & Namkeen
    {
      categoryId: categoryMap['snacks-namkeen'],
      name: 'Haldiram’s Aloo Bhujia',
      brand: 'Haldiram’s',
      description: 'Crispy, spicy potato namkeen – classic',
    ...
    // Pickles & Chutneys
    {
      ...
      description: 'Spicy & tangy South Indian style',
  ...
  console.log('Run `npm run dev` to see the site with real data.');
}
